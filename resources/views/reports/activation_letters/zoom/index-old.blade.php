      ...
      <div class=" tm_style1" id="tm_download_section">
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_align_center tm_mb20">
            ...
            <p class="code desc" style="margin-top: 106px;">{{ $activation_letter->company->name }}</p>
            <p class="code desc" style="margin-top: -12px;">{{ $activation_letter->name }} </p>
            ...
            <p class="code desc" style="margin-top: -10px;">{{ Carbon\Carbon::parse($activation_letter->start_date)->format('d M, Y') }}</</p>
            ...
            <p class="code desc" style="margin-top: -13px;margin-left: 315px;">{{ '(+62) ' . $activation_letter->user->employee->phone_number }}</p>
