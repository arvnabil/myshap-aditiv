...
use App\Filament\Resources\ZoomSubAccountResource\Pages;
use App\Filament\Resources\ZoomSubAccountResource\RelationManagers;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('end_date')
                    ->label('End')
                    ->searchable(),
                TextColumn::make('zoom_product_type.name')
                    ->label('Product Type')
                    ->searchable(),
