...
use App\Services\General\GeneralServiceImplement;
...
function logExecute(string $title, string $activityType, $before = null, $after = null)
{
    ...
    $generalService = new GeneralServiceImplement;
 ...
 * @return ActivityLog
 */
function logGenerateTokenZoom(string $nextTextTitle, $before, $after)
{
    $title        = __($nextTextTitle . ' sukses di generate!');
    $activityType = ZOOM_ACCOUNT_CREDENTIALS;
    $before       = $before;
    $after        = $after;
    return logExecute($title, $activityType, $before, $after);
}
